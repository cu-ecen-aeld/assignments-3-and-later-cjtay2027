...
if [ ! -e ${OUTDIR}/linux-stable/arch/${ARCH}/boot/Image ]; then
    ...
    # TODO: Add your kernel build steps here, follow building linux tutorial
    # Deep clean a pre-exist build
...
# TODO: Create necessary base directories, follow tutorial on linux rootfs
